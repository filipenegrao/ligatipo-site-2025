...
import LogoLigatipo from "@/components/svgs/logo-ligatipo";
...
export default function LoginPage() {
  ...
  return (
    <section className={`section ${styles["section-login"]}`}>
      <div className={`section-content ${styles["content"]}`}>
        <LogoLigatipo />
        <h1 className={`section-header ${styles["title"]}`}>Faça seu login</h1>
